...
var OpenAPIClientAxios = /** @class */ (function () {
    ...
    function OpenAPIClientAxios(opts) {
        ...
        this.getAxiosInstance = function () {
            ...
            if (!instance) {
                instance = axios_1.default.create(_this.axiosConfigDefaults);
            }
            return instance;
        };
        /**
        ...
        this.quick = (_b = opts.quick) !== null && _b !== void 0 ? _b : false;
        this.axiosConfigDefaults = (_c = opts.axiosConfigDefaults) !== null && _c !== void 0 ? _c : {};
        this.instance = opts.axiosInstance;
        this.defaultServer = (_d = opts.withServer) !== null && _d !== void 0 ? _d : 0;
        this.baseURLVariables = (_e = opts.baseURLVariables) !== null && _e !== void 0 ? _e : {};
        this.applyMethodCommonHeaders = (_f = opts.applyMethodCommonHeaders) !== null && _f !== void 0 ? _f : false;
        this.transformOperationName = (_g = opts.transformOperationName) !== null && _g !== void 0 ? _g : (function (operationId) { return operationId; });
        this.transformOperationMethod =
            (_h = opts.transformOperationMethod) !== null && _h !== void 0 ? _h : (function (operationMethod) { return operationMethod; });
        this.runners = (_a = {},
            _a[DefaultRunnerKey] = {
                runRequest: (_j = opts.axiosRunner) !== null && _j !== void 0 ? _j : (function (axiosConfig) { return _this.client.request(axiosConfig); }),
            },
            _a);
    }
